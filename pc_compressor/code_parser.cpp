    ...
    BreakCondition breakCondition)
{
    ...
    Register16* bc = nullptr;
    Register16* de = nullptr;
    Register16* hl = nullptr;
    ...
    auto findRegusters =
        [&]()
        {
            bc = findRegister(result.outputRegisters, "bc", isAltReg);
            de = findRegister(result.outputRegisters, "de", isAltReg);
            hl = findRegister(result.outputRegisters, "hl", isAltReg);
